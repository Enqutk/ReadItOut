...
/** Professional Instagram-style icon (camera + rounded square) */
export function IconInstagram({ className = '', size = 24 }: { className?: string; size?: number }) {
  return (
    <svg
...
/** Professional TikTok-style icon */
export function IconTikTok({ className = '', size = 24 }: { className?: string; size?: number }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const SOCIAL_LINK_LABELS: Record<string, string> = {
  ...
  tiktok_leyu: 'TikTok (Leyu)',
  tiktok_mahi: 'TikTok (Mahi)',
};
